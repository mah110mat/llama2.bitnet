...
def serialize_fp32(file, tensor, msg=""):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--version", default=45400, type=int, help="the version to export with")
